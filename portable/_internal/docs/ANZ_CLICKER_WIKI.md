...
- OCR-related packaging changes belong in `Anz Clicker.spec`.
...
```powershell
pyinstaller "Anz Clicker.spec"
```

Do not add new duplicate spec files. Update `Anz Clicker.spec` when bundled assets change.
